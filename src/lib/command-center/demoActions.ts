import type { ActionItem, BatchGroup } from './types'

// ── In-memory demo data ──
// Shared across the actions list, approve, and batch-approve routes.
...
export function buildBatchGroups(actions: ActionItem[]): BatchGroup[] {
