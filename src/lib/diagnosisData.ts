...
export const DIAGNOSIS_CATEGORIES: DiagnosisCategory[] = [
  ...
  },
  {
    ...
    diagnoses: [
      ...
      { id: 'parkinsons-psychosis', name: "Parkinson's Disease - Psychosis", icd10: 'F06.0', category: 'movement-disorders', hasSmartPlan: true },
  ...
  },
  {
    ...
    diagnoses: [
      ...
      { id: 'radiation-injury', name: 'Radiation-Induced Neurologic Injury', icd10: 'G93.89', category: 'neuro-oncology', hasSmartPlan: true },
    ],
  },
  {
    id: 'spinal-cord',
  ...
  },
  {
    ...
    diagnoses: [
      ...
      { id: 'sleep-apnea', name: 'Sleep Apnea', icd10: 'G47.33', category: 'other-misc', hasSmartPlan: true },
