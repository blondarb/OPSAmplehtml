...
export const CONSULT_TO_DIAGNOSIS_MAP: Record<string, string[]> = {
  ...
  'Seizure in pregnancy': ['eclampsia-seizure'],
  ...
  'Nystagmus': ['nystagmus-evaluation'],
  ...
  'Tremor evaluation': ['essential-tremor', 'symptom-tremor'],
  'Second opinion': [],
  'Back pain with neuro symptoms': ['radiculopathy', 'myelopathy-evaluation', 'symptom-low-back-pain'],
  'Neck pain with neuro symptoms': ['radiculopathy', 'cervical-myelopathy', 'symptom-neck-pain'],
  'Concussion/Post-concussion syndrome': ['post-concussion-syndrome', 'tbi'],
  'Bell palsy': ['bells-palsy'],
  'Meningitis/Encephalitis': ['bacterial-meningitis', 'viral-meningitis', 'hsv-encephalitis', 'autoimmune-encephalitis'],
  'CNS infection': ['neurocysticercosis', 'neurosyphilis', 'lyme-neuro', 'fungal-meningitis', 'tb-meningitis'],
  'Brain tumor': ['brain-metastases', 'glioblastoma', 'meningioma', 'cns-lymphoma'],
  'Spinal cord disorder': ['myelopathy-evaluation', 'cervical-myelopathy', 'cauda-equina', 'spinal-cord-compression'],
  'Functional neurological disorder': ['fnd', 'functional-weakness', 'functional-movement'],
  'Autoimmune neurologic disorder': ['neurosarcoidosis', 'susac-syndrome', 'neuro-behcets', 'hashimotos-encephalopathy', 'stiff-person'],
...
export const DIAGNOSIS_CATEGORIES: DiagnosisCategory[] = [
  {
    ...
    diagnoses: [
      ...
      { id: 'ncse', name: 'Non-Convulsive Status Epilepticus', icd10: 'G41.0', category: 'seizure-epilepsy', hasSmartPlan: true },
      { id: 'alcohol-withdrawal-seizure', name: 'Alcohol Withdrawal Seizure', icd10: 'G40.509', category: 'seizure-epilepsy', hasSmartPlan: true },
      { id: 'eclampsia-seizure', name: 'Eclampsia/Seizure in Pregnancy', icd10: 'O15.9', category: 'seizure-epilepsy', hasSmartPlan: true },
      { id: 'drug-resistant-epilepsy', name: 'Drug-Resistant Epilepsy', icd10: 'G40.919', category: 'seizure-epilepsy', hasSmartPlan: true },
      { id: 'epilepsy-management', name: 'Epilepsy - Chronic Management', icd10: 'G40.909', category: 'seizure-epilepsy', hasSmartPlan: true },
    ],
  },
  {
    ...
    diagnoses: [
      ...
      { id: 'ich', name: 'Intracerebral Hemorrhage', icd10: 'I61.9', category: 'stroke-cerebrovascular', hasSmartPlan: true },
      { id: 'sah', name: 'Subarachnoid Hemorrhage', icd10: 'I60.9', category: 'stroke-cerebrovascular', hasSmartPlan: true },
      { id: 'tia', name: 'Transient Ischemic Attack', icd10: 'G45.9', category: 'stroke-cerebrovascular', hasSmartPlan: true },
      { id: 'cvt', name: 'Cerebral Venous Thrombosis', icd10: 'I67.6', category: 'stroke-cerebrovascular', hasSmartPlan: true },
      { id: 'carotid-dissection', name: 'Carotid/Vertebral Artery Dissection', icd10: 'I77.71', category: 'stroke-cerebrovascular', hasSmartPlan: true },
      { id: 'pres', name: 'Posterior Reversible Encephalopathy', icd10: 'G93.49', category: 'stroke-cerebrovascular', hasSmartPlan: true },
  ...
  },
  {
    ...
    diagnoses: [
      ...
      { id: 'migraine-with-aura', name: 'Migraine with aura', icd10: 'G43.109', category: 'headache', hasSmartPlan: true },
      { id: 'migraine-without-aura', name: 'Migraine without aura', icd10: 'G43.009', category: 'headache', hasSmartPlan: true },
      { id: 'chronic-migraine', name: 'Chronic Migraine', icd10: 'G43.709', category: 'headache', hasSmartPlan: true },
      { id: 'status-migrainosus', name: 'Status Migrainosus', icd10: 'G43.901', category: 'headache', hasSmartPlan: true },
      { id: 'cluster-headache', name: 'Cluster Headache', icd10: 'G44.009', category: 'headache', hasSmartPlan: true },
      { id: 'tension-headache', name: 'Tension-type Headache', icd10: 'G44.209', category: 'headache', hasSmartPlan: true },
      { id: 'medication-overuse-headache', name: 'Medication Overuse Headache', icd10: 'G44.41', category: 'headache', hasSmartPlan: true },
      { id: 'iih', name: 'Idiopathic Intracranial Hypertension', icd10: 'G93.2', category: 'headache', hasSmartPlan: true },
  ...
  },
  {
    ...
    icon: '🧬',
    diagnoses: [
      { id: 'ms-exacerbation', name: 'MS Exacerbation', icd10: 'G35', category: 'demyelinating', hasSmartPlan: true },
      { id: 'ms-new-diagnosis', name: 'MS - New Diagnosis', icd10: 'G35', category: 'demyelinating', hasSmartPlan: true },
      { id: 'ms-chronic-management', name: 'MS - Chronic Management', icd10: 'G35', category: 'demyelinating', hasSmartPlan: true },
      { id: 'nmo', name: 'Neuromyelitis Optica', icd10: 'G36.0', category: 'demyelinating', hasSmartPlan: true },
      { id: 'mog-antibody-disease', name: 'MOG Antibody Disease', icd10: 'G36.9', category: 'demyelinating', hasSmartPlan: true },
      { id: 'transverse-myelitis', name: 'Transverse Myelitis', icd10: 'G37.3', category: 'demyelinating', hasSmartPlan: true },
      { id: 'optic-neuritis', name: 'Optic Neuritis', icd10: 'H46.9', category: 'demyelinating', hasSmartPlan: true },
      { id: 'adem', name: 'Acute Disseminated Encephalomyelitis', icd10: 'G04.81', category: 'demyelinating', hasSmartPlan: true },
      { id: 'pml', name: 'Progressive Multifocal Leukoencephalopathy', icd10: 'A81.2', category: 'demyelinating', hasSmartPlan: true },
    ],
  },
  {
    id: 'neuromuscular',
    ...
    icon: '💪',
    diagnoses: [
      { id: 'diffuse-weakness', name: 'Diffuse Weakness', icd10: 'R53.1', category: 'neuromuscular', hasSmartPlan: true },
      { id: 'gbs', name: 'Guillain-Barré Syndrome', icd10: 'G61.0', category: 'neuromuscular', hasSmartPlan: true },
      { id: 'myasthenia-exacerbation', name: 'Myasthenia Gravis - Exacerbation/Crisis', icd10: 'G70.01', category: 'neuromuscular', hasSmartPlan: true },
      { id: 'myasthenia-new', name: 'Myasthenia Gravis - New Diagnosis', icd10: 'G70.00', category: 'neuromuscular', hasSmartPlan: true },
      { id: 'myasthenia-chronic', name: 'Myasthenia Gravis - Chronic Management', icd10: 'G70.00', category: 'neuromuscular', hasSmartPlan: true },
      { id: 'cidp', name: 'CIDP', icd10: 'G61.81', category: 'neuromuscular', hasSmartPlan: true },
      { id: 'als', name: 'Amyotrophic Lateral Sclerosis', icd10: 'G12.21', category: 'neuromuscular', hasSmartPlan: true },
      { id: 'lems', name: 'Lambert-Eaton Myasthenic Syndrome', icd10: 'G73.1', category: 'neuromuscular', hasSmartPlan: true },
      { id: 'inflammatory-myopathy', name: 'Inflammatory Myopathy', icd10: 'G72.41', category: 'neuromuscular', hasSmartPlan: true },
      { id: 'ibm', name: 'Inclusion Body Myositis', icd10: 'G72.41', category: 'neuromuscular', hasSmartPlan: true },
  ...
  },
  {
    ...
    diagnoses: [
      ...
      { id: 'diabetic-neuropathy', name: 'Diabetic Neuropathy', icd10: 'E11.42', category: 'neuropathy', hasSmartPlan: true },
      { id: 'small-fiber-neuropathy', name: 'Small Fiber Neuropathy', icd10: 'G62.9', category: 'neuropathy', hasSmartPlan: true },
      { id: 'b12-deficiency-neuropathy', name: 'B12 Deficiency Neuropathy', icd10: 'E53.8', category: 'neuropathy', hasSmartPlan: true },
  ...
  },
  {
    ...
    icon: '🧍',
    diagnoses: [
      { id: 'parkinsons-new', name: "Parkinson's Disease - New Diagnosis", icd10: 'G20', category: 'movement-disorders', hasSmartPlan: true },
      { id: 'parkinsons-management', name: "Parkinson's Disease - Management", icd10: 'G20', category: 'movement-disorders', hasSmartPlan: true },
      { id: 'parkinsons-fluctuations', name: "Parkinson's Disease - Motor Fluctuations", icd10: 'G20', category: 'movement-disorders', hasSmartPlan: true },
      { id: 'parkinsons-psychosis', name: "Parkinson's Disease - Psychosis", icd10: 'F06.0', category: 'movement-disorders' },
      { id: 'essential-tremor', name: 'Essential Tremor', icd10: 'G25.0', category: 'movement-disorders', hasSmartPlan: true },
      { id: 'dystonia', name: 'Dystonia', icd10: 'G24.9', category: 'movement-disorders', hasSmartPlan: true },
      { id: 'huntingtons-disease', name: "Huntington's Disease", icd10: 'G10', category: 'movement-disorders', hasSmartPlan: true },
      { id: 'tardive-dyskinesia', name: 'Tardive Dyskinesia', icd10: 'G24.01', category: 'movement-disorders', hasSmartPlan: true },
      { id: 'drug-induced-parkinsonism', name: 'Drug-Induced Parkinsonism', icd10: 'G21.11', category: 'movement-disorders', hasSmartPlan: true },
      { id: 'wilsons-disease', name: "Wilson's Disease", icd10: 'E83.01', category: 'movement-disorders', hasSmartPlan: true },
      { id: 'psp', name: 'Progressive Supranuclear Palsy', icd10: 'G23.1', category: 'movement-disorders', hasSmartPlan: true },
  ...
  },
  {
    ...
    icon: '🧩',
    diagnoses: [
      { id: 'dementia-evaluation', name: 'Dementia Evaluation', icd10: 'R41.81', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'alzheimers-disease', name: "Alzheimer's Disease", icd10: 'G30.9', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'vascular-dementia', name: 'Vascular Dementia', icd10: 'F01.50', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'lewy-body-dementia', name: 'Lewy Body Dementia', icd10: 'G31.83', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'frontotemporal-dementia', name: 'Frontotemporal Dementia', icd10: 'G31.09', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'rapidly-progressive-dementia', name: 'Rapidly Progressive Dementia', icd10: 'F03.90', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'nph', name: 'Normal Pressure Hydrocephalus', icd10: 'G91.2', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'cjd', name: 'Creutzfeldt-Jakob Disease', icd10: 'A81.00', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'autoimmune-dementia', name: 'Autoimmune Dementia/Encephalopathy', icd10: 'G04.81', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'mci', name: 'Mild Cognitive Impairment', icd10: 'G31.84', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'delirium-vs-dementia', name: 'Delirium vs Dementia', icd10: 'R41.0', category: 'dementia-cognitive', hasSmartPlan: true },
      { id: 'wernicke-korsakoff', name: 'Wernicke-Korsakoff Syndrome', icd10: 'F10.96', category: 'dementia-cognitive', hasSmartPlan: true },
    ],
  },
  {
    id: 'cns-infections',
    ...
    icon: '🦠',
    diagnoses: [
      { id: 'bacterial-meningitis', name: 'Bacterial Meningitis', icd10: 'G00.9', category: 'cns-infections', hasSmartPlan: true },
      { id: 'viral-meningitis', name: 'Viral Meningitis', icd10: 'A87.9', category: 'cns-infections', hasSmartPlan: true },
      { id: 'hsv-encephalitis', name: 'HSV Encephalitis', icd10: 'B00.4', category: 'cns-infections', hasSmartPlan: true },
  ...
  },
  {
    ...
    icon: '🎗️',
    diagnoses: [
      { id: 'brain-metastases', name: 'Brain Metastases', icd10: 'C79.31', category: 'neuro-oncology', hasSmartPlan: true },
      { id: 'glioblastoma', name: 'Glioblastoma', icd10: 'C71.9', category: 'neuro-oncology', hasSmartPlan: true },
      { id: 'leptomeningeal', name: 'Leptomeningeal Carcinomatosis', icd10: 'C79.32', category: 'neuro-oncology', hasSmartPlan: true },
      { id: 'paraneoplastic', name: 'Paraneoplastic Neurological Syndrome', icd10: 'G13.0', category: 'neuro-oncology', hasSmartPlan: true },
      { id: 'spinal-cord-compression', name: 'Spinal Cord Compression', icd10: 'G95.20', category: 'neuro-oncology', hasSmartPlan: true },
      { id: 'meningioma', name: 'Meningioma', icd10: 'D32.9', category: 'neuro-oncology', hasSmartPlan: true },
      { id: 'cns-lymphoma', name: 'Primary CNS Lymphoma', icd10: 'C85.19', category: 'neuro-oncology', hasSmartPlan: true },
  ...
  },
  {
    ...
    icon: '🦴',
    diagnoses: [
      { id: 'myelopathy-evaluation', name: 'Acute Myelopathy Evaluation', icd10: 'G95.9', category: 'spinal-cord', hasSmartPlan: true },
      { id: 'cervical-myelopathy', name: 'Cervical Myelopathy', icd10: 'M47.12', category: 'spinal-cord', hasSmartPlan: true },
      { id: 'spinal-cord-infarction', name: 'Spinal Cord Infarction', icd10: 'G95.11', category: 'spinal-cord', hasSmartPlan: true },
      { id: 'syringomyelia', name: 'Syringomyelia', icd10: 'G95.0', category: 'spinal-cord', hasSmartPlan: true },
      { id: 'subacute-combined', name: 'Subacute Combined Degeneration', icd10: 'E53.8', category: 'spinal-cord', hasSmartPlan: true },
      { id: 'cauda-equina', name: 'Cauda Equina Syndrome', icd10: 'G83.4', category: 'spinal-cord', hasSmartPlan: true },
      { id: 'epidural-abscess', name: 'Epidural Abscess', icd10: 'G06.1', category: 'spinal-cord', hasSmartPlan: true },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: '🧘',
    diagnoses: [
      { id: 'fnd', name: 'Functional Neurological Disorder', icd10: 'F44.9', category: 'functional-psychiatric', hasSmartPlan: true },
      { id: 'pnes', name: 'Psychogenic Non-Epileptic Spells', icd10: 'F44.5', category: 'functional-psychiatric', hasSmartPlan: true },
      { id: 'functional-weakness', name: 'Functional Weakness', icd10: 'F44.4', category: 'functional-psychiatric', hasSmartPlan: true },
      { id: 'functional-movement', name: 'Functional Movement Disorder', icd10: 'F44.4', category: 'functional-psychiatric', hasSmartPlan: true },
    ],
  },
  {
    ...
    icon: '🏥',
    diagnoses: [
      { id: 'elevated-icp', name: 'Elevated ICP Management', icd10: 'G93.2', category: 'neurocritical-care', hasSmartPlan: true },
      { id: 'brain-death', name: 'Brain Death Evaluation', icd10: 'G93.82', category: 'neurocritical-care', hasSmartPlan: true },
      { id: 'anoxic-brain-injury', name: 'Anoxic Brain Injury/Prognostication', icd10: 'G93.1', category: 'neurocritical-care', hasSmartPlan: true },
      { id: 'neuromuscular-respiratory', name: 'Neuromuscular Respiratory Failure', icd10: 'G71.9', category: 'neurocritical-care', hasSmartPlan: true },
      { id: 'hypertensive-encephalopathy', name: 'Hypertensive Encephalopathy', icd10: 'I67.4', category: 'neurocritical-care', hasSmartPlan: true },
    ],
  },
  {
    id: 'other-misc',
    ...
    icon: '📦',
    diagnoses: [
      { id: 'syncope-evaluation', name: 'Syncope Evaluation', icd10: 'R55', category: 'other-misc', hasSmartPlan: true },
      ...
      { id: 'narcolepsy', name: 'Narcolepsy', icd10: 'G47.419', category: 'other-misc', hasSmartPlan: true },
...
const DIAGNOSIS_SYNONYMS: Record<string, string[]> = {
  ...
  'fainting': ['syncope-evaluation'],

  // Condition names and common terms
  'headache': ['headache-evaluation', 'symptom-headache', 'migraine-unspecified'],
  ...
  'tremor': ['essential-tremor', 'parkinsons-new', 'symptom-tremor'],
  ...
  'meningitis': ['bacterial-meningitis', 'viral-meningitis', 'fungal-meningitis', 'tb-meningitis'],
  'encephalitis': ['hsv-encephalitis', 'autoimmune-encephalitis'],
  ...
  'carotid': ['carotid-stenosis', 'carotid-dissection'],
  'carotid stenosis': ['carotid-stenosis'],
  'stiff person': ['stiff-person'],
  'neurocysticercosis': ['neurocysticercosis'],

  // Eponymous / named conditions
  ...
  'bell': ['bells-palsy'],
  'bells': ['bells-palsy'],
  'tourette': ['tics-tourette'],
  'tourettes': ['tics-tourette'],
  'tics': ['tics-tourette'],
  'behcets': ['neuro-behcets'],
  'behcet': ['neuro-behcets'],
  'hashimoto': ['hashimotos-encephalopathy'],
  'hashimotos': ['hashimotos-encephalopathy'],
  'sreat': ['hashimotos-encephalopathy'],
  'susac': ['susac-syndrome'],
  'horner': ['horner-syndrome'],
  'horners': ['horner-syndrome'],
  'hiv': ['hiv-neurocognitive'],
  'hiv dementia': ['hiv-neurocognitive'],
}
