// AWS RDS global CA bundle (all regions) — vendored as a string so it survives
// Amplify SSR Lambda bundling (loose .pem files get dropped from the bundle).
// Source: https://truststore.pki.rds.amazonaws.com/global/global-bundle.pem
// Downloaded 2026-06-06. Contains 108 root CAs (all regions incl. us-east-2).
// Refresh: re-download from the URL above and replace the template literal.
// (No backticks or ${} appear in PEM base64, so a raw template literal is safe.)
