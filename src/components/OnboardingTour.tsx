...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    description: 'Click your profile icon to access Settings. Customize AI instructions, documentation style preferences, and appearance options including dark mode.',
  ...
  },
  {
    ...
    description: 'You\'re ready to start documenting. Remember: the red mic button is for voice, the teal star is for AI assistance, and purple lightning opens dot phrases. Happy documenting!',
    target: 'body',
    position: 'bottom',
  },
]
