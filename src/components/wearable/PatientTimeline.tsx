...
import type { DailySummary, WearableAnomaly, WearablePatient, TremorAssessment, FluencyAssessment } from '@/lib/wearable/types'
...
export default function PatientTimeline({ dailySummaries, anomalies, patient, assessments, fluencyAssessments }: PatientTimelineProps) {
