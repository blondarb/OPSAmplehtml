...
import { resetScheduleTour } from '../OnboardingTour'
...
export default function AppointmentsDashboard({
  ...
  // Testing banner state
  const [showTestingBanner, setShowTestingBanner] = useState(() => {
    try {
      return !localStorage.getItem('sevaro-testing-banner-dismissed-feb-2026')
    } catch {
      return true
    }
  })
  ...
  // Testing banner handlers
  const dismissTestingBanner = () => {
    try {
      localStorage.setItem('sevaro-testing-banner-dismissed-feb-2026', 'true')
    } catch {}
      ...
      {showTestingBanner && (
        <div style={{
          ...
          <span style={{ flex: 1, fontSize: '13px', color: '#92400E', lineHeight: '1.5' }}>
            <strong>Preferred testing dates:</strong> February 4–6, 2026.
            Need a refresher?{' '}
            <button
