...
2. GATHER THE FAST SET, urgently, LAST KNOWN WELL FIRST (it's the pivot that decides the tier): "Quickly — when was the patient last known well, what are the symptoms, and their name, MRN, and date of birth?" One breath; take the answers in any order.
