...
for (const method of ['delete', 'eq', 'gte', 'gt', 'in', 'not', 'select', 'update']) {
...
describe('POST /api/demo/reset', () => {
  beforeEach(() => {
    ...
    getUserMock.mockResolvedValue({ id: 'synthetic-user' })
  ...
  it('is permanently retired before request parsing or dependency access', async () => {
    const request = new NextRequest('http://localhost/api/demo/reset', {
      method: 'POST',
      headers: {
