...
**Status**: Active — verified July 1, 2026
...
### Planned
- Acoustic speech biomarkers — **Phase A scaffolded** behind `VOICE_BIOMARKERS_ENABLED` (🎯 test-week bake-off): pure-TS engine + `/api/ai/voice-biomarkers` + capture UI + `/voice-biomarkers` runner. Remaining: engine comparison (Parselmouth/eGeMAPS/DisVoice vs pure-TS) on labeled profiles, threshold tuning, MDS-UPDRS speech-item mapping, go/no-go on a Python sidecar for jitter/shimmer/HNR. Spec: `docs/plans/2026-06-30-acoustic-speech-biomarkers-spec.md`
