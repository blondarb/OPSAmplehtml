...
function useEventTracker() {
  ...
  const getOffsetMs = react.useCallback(() => {
  ...
  const getElementSelector2 = react.useCallback((el) => {
  ...
  const logCustomEvent = react.useCallback(
    (name, detail) => {
...
function useFeedbackApi(apiUrl, apiKey) {
  ...
  const audioUploadUrlRef = react.useRef(null);
  const appIdRef = react.useRef(null);
  ...
  const uploadAudio = react.useCallback(async (blob) => {
...
function useScreenshotAnnotation(uploadScreenshot) {
  ...
  const [lastAnnotation, setLastAnnotation] = react.useState(null);
...
function MicIcon({ size = 16 }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [
...
function ChatIcon({ size = 16 }) {
  return /* @__PURE__ */ jsxRuntime.jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" }) });
}
...
function SendIcon({ size = 16 }) {
  return /* @__PURE__ */ jsxRuntime.jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M2.01 21L23 12 2.01 3 2 10l15 2-15 2z" }) });
}
function FeedbackWidget({ appId, apiUrl, user, position = "bottom-right", apiKey, chatApiUrl }) {
  const [widgetState, setWidgetState] = react.useState("idle");
  const [isExpanded, setIsExpanded] = react.useState(false);
  const [category, setCategory] = react.useState("suggestion");
  const [errorMessage, setErrorMessage] = react.useState(null);
  const [chatInput, setChatInput] = react.useState("");
  const [isVoiceRecordingInChat, setIsVoiceRecordingInChat] = react.useState(false);
  const [submittingTooLong, setSubmittingTooLong] = react.useState(false);
  const submittingTimerRef = react.useRef(null);
  const sessionStartRef = react.useRef(0);
  const sessionIdRef = react.useRef(null);
  const inactivityTimerRef = react.useRef(null);
  const chatMessagesEndRef = react.useRef(null);
  const initTimerRef = react.useRef(null);
  ...
  const uploadScreenshotForAnnotation = react.useCallback(async (blob, index) => {
  ...
  const handleEndChat = react.useCallback(async () => {
    try {
      setWidgetState("submitting");
      tracker.stopTracking();
      const duration = Math.round((Date.now() - sessionStartRef.current) / 1e3);
  ...
  const handleVoiceInChat = react.useCallback(async () => {
  ...
  const renderChatMessages = () => /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
    flex: 1,
    overflowY: "auto",
    padding: "8px 12px",
    display: "flex",
    ...
    chat.messages.filter((m) => m.content !== "__init__").map((msg) => /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
      display: "flex",
      ...
      msg.content,
      msg.attachments?.some((a) => a.type === "annotation") && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
        marginTop: 4,
        fontSize: 11,
        opacity: 0.8,
        display: "flex",
        ...
        /* @__PURE__ */ jsxRuntime.jsx(CameraIcon, { size: 11 }),
        " Screenshot attached"
      ] })
    ] }) }, msg.id)),
    chat.isLoading && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", justifyContent: "flex-start" }, children: /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
      padding: "8px 16px",
      borderRadius: "12px 12px 12px 2px",
      backgroundColor: "#F3F4F6",
      color: "#9CA3AF",
      fontSize: 13
    }, children: /* @__PURE__ */ jsxRuntime.jsx("span", { style: { animation: "feedback-pulse 1.2s ease-in-out infinite" }, children: "Thinking..." }) }) }),
    /* @__PURE__ */ jsxRuntime.jsx("div", { ref: chatMessagesEndRef })
  ] });
  const renderChatInput = () => /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
    padding: "8px 12px",
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(CameraIcon, { size: 16 })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(MicIcon, { size: 16 })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      "input",
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(SendIcon, { size: 16 })
      }
    )
  ] });
  if (widgetState === "recording" && !isExpanded) {
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { "data-feedback-widget": true, style: { ...positionStyle, position: "fixed", zIndex: 99999 }, children: [
      /* @__PURE__ */ jsxRuntime.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { style: { width: 8, height: 8, borderRadius: 4, backgroundColor: "#fff" } }),
      ...
      /* @__PURE__ */ jsxRuntime.jsx("style", { children: `@keyframes feedback-pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.85; } }` })
    ] });
  }
  if (widgetState === "chatting" && !isExpanded) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { "data-feedback-widget": true, style: { ...positionStyle, position: "fixed", zIndex: 99999 }, children: /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        style: {
          display: "flex",
        ...
        onClick: () => setIsExpanded(true),
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(ChatIcon, { size: 14 }),
          "Chat (",
  ...
  if ((widgetState === "idle" || widgetState === "annotating") && !isExpanded) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { "data-feedback-widget": true, style: { ...positionStyle, position: "fixed", zIndex: 99999 }, children: /* @__PURE__ */ jsxRuntime.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(ChatIcon, { size: 18 }),
          "Give Feedback"
        ]
      }
    ) });
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
            widgetState === "recording" && /* @__PURE__ */ jsxRuntime.jsx("span", { style: {
              width: 10,
              height: 10,
              borderRadius: 5,
              backgroundColor: "#fff",
            ...
            widgetState === "chatting" && /* @__PURE__ */ jsxRuntime.jsx(ChatIcon, { size: 16 }),
            /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontSize: 14, fontWeight: 600 }, children: headerTitle })
          ] }),
          widgetState !== "submitting" && widgetState !== "submitted" && /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              onClick: () => {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: widgetState === "chatting" ? 0 : 16, flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }, children: [
          (widgetState === "error" || recorder.error) && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { padding: widgetState === "chatting" ? 12 : 0, marginBottom: 12 }, children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: handleReset, style: {
              marginTop: 8,
              padding: "6px 14px",
              borderRadius: 6,
          ...
          widgetState === "submitted" && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { textAlign: "center", padding: "8px 0" }, children: /* @__PURE__ */ jsxRuntime.jsx("p", { style: { fontSize: 14, color: "#374151", margin: 0 }, children: "Your feedback has been recorded and will be reviewed." }) }),
          widgetState === "submitting" && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { textAlign: "center", padding: "8px 0" }, children: [
            /* @__PURE__ */ jsxRuntime.jsx("p", { style: { fontSize: 14, color: "#6B7280", margin: 0 }, children: "Uploading your feedback..." }),
            submittingTooLong && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
              /* @__PURE__ */ jsxRuntime.jsx("p", { style: { fontSize: 12, color: "#9CA3AF", margin: "8px 0 4px 0" }, children: "This is taking longer than expected." }),
              /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: handleReset, style: {
                marginTop: 4,
                padding: "6px 14px",
                borderRadius: 6,
          ...
          widgetState === "idle" && !recorder.error && !errorMessage && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsx("p", { style: { fontSize: 13, color: "#6B7280", margin: "0 0 12px 0", lineHeight: 1.4 }, children: chatEnabled ? "Chat or record while you navigate \u2014 we track which page you're on automatically. Click around the app to show us exactly where something needs attention." : "Hit record and navigate the app \u2014 we'll track which page you're on. Talk through what you see as you click around." }),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { marginBottom: 14 }, children: [
              /* @__PURE__ */ jsxRuntime.jsx("label", { style: { fontSize: 12, color: "#9CA3AF", fontWeight: 500, display: "block", marginBottom: 6 }, children: "Category" }),
              /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", gap: 6, flexWrap: "wrap" }, children: CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
            ...
            /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", gap: 8 }, children: [
              chatEnabled && /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(ChatIcon, { size: 16 }),
                    "Chat"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(MicIcon, { size: 16 }),
          ...
          widgetState === "recording" && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsx("p", { style: { fontSize: 11, color: "#9CA3AF", margin: "0 0 8px 0", lineHeight: 1.4, fontStyle: "italic" }, children: "Navigate around \u2014 we're tracking where you are." }),
            /* @__PURE__ */ jsxRuntime.jsxs("div", { style: {
              padding: "8px 12px",
              borderRadius: 8,
              ...
              /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }, children: [
                /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontWeight: 600, color: "#374151" }, children: "Page:" }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontFamily: "monospace" }, children: tracker.getCurrentContext().route })
              ] }),
              tracker.getCurrentContext().viewportSection && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                /* @__PURE__ */ jsxRuntime.jsx("span", { style: { fontWeight: 600, color: "#374151" }, children: "Section:" }),
                /* @__PURE__ */ jsxRuntime.jsx("span", { children: tracker.getCurrentContext().viewportSection })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", gap: 4, flexWrap: "wrap", marginBottom: 12 }, children: CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntime.jsxs(
              "button",
              {
                onClick: () => setCategory(cat.value),
                style: {
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "currentColor", children: /* @__PURE__ */ jsxRuntime.jsx("rect", { x: "6", y: "6", width: "12", height: "12", rx: "2" }) }),
                  "Stop & Submit"
                ]
              }
            )
          ] }),
          widgetState === "chatting" && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            renderChatMessages(),
            renderChatInput(),
            /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
              padding: "6px 12px",
...
exports.useFeedbackApi = useFeedbackApi;
exports.useScreenshotAnnotation = useScreenshotAnnotation;
